...
class App:
    def __init__(self, root):
        ...
        # Load buttons
        self.load_button_all = tk.Button(root, text="Load All", command=self.load_all_files)
        self.load_button_all.grid(row=1, column=2, padx=5, pady=5)

        self.load_button_selected = tk.Button(root, text="Load Selected", command=self.load_selected_files)
        self.load_button_selected.grid(row=1, column=3, padx=5, pady=5)
